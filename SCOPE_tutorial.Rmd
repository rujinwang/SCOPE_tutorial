...
# Step 4. Align FASTQ sequences to NCBI hg19 reference genome (Single-end sequencing cells have only 1 FASTQ file; paired-end sequencing would generate two FASTQ files, with suffix "_1" and "_2")
cd $fastq_dir
bwa mem -M -t 16 \
