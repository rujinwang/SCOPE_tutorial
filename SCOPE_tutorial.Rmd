...
## 1.4 SCOPE for hg38
The whole-genome mappability track on human hg38 assembly is stored in SCOPE package. For more details on mappability calculation, please refer to [CODEX2 for hg38](https://github.com/yuchaojiang/CODEX2#codex2-for-hg38). 
...
Note that SCOPE can also be adapted to the mouse genome (mm10) in a similar way (see [CODEX2 for mouse genome](https://github.com/yuchaojiang/CODEX2#codex2-for-mouse-genome)).
