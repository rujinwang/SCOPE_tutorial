...
#'  under the case-control setting in parallel
#'
...
#' @import stats
#' @export
normalize_scope_foreach = function (Y_qc, gc_qc, K, norm_index, N, T, alpha0, beta0, minCountQC = 20) {
  ...
  fhat.temp=getfGC_foreach(gcfit.temp = gcfit.temp, gctemp = gc_qc, Y = Y_qc, norm_index = norm_index, offset = offset, T = T, alpha = alpha0, minCountQC = minCountQC)
