...
#' @param mode format of returned copy numbers, which can be either "integer" or "fraction".
#'  "integer" is recommended for scDNA-seq data.
...
#' @export
segmentCBScs = function(Y, Yhat, sampname, ref, lmax, mode, segment.CODEX2 = FALSE) {
	poolcall = NULL
	lmax = lmax - 1
